...
const Report = () => {
  return (
    <div className="grid-one-item grid-common grid-common1 grid-c3">
                    ...
                    reportData.map((report) => (
                        <div className="grid-chart-bar" key={report.id}>
                            <div className="bar-wrapper">
                                <div className="bar-item1 bar1-item1" style={{ height: `${report.value1 !== null ? "40%" : ""}` }}></div>
                                <div className="bar-item2 bar1-item2" style={{ height: `${report.value2 !== null ? "60%" : ""}` }}></div>
                            </div>
