...
export const iconsImgs = {
    email,notification,logout,record,message,patient, schedule, dashboard,alert, bell, bills, doctor, budget, card, check, empty_check, gears, home, menu, plane, plus, report, search, user, wallet, wealth
}
